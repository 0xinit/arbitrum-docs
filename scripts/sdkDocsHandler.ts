...
// Files generated by TypeDoc that should be excluded from the sidebar and cleaned up
const GENERATED_EXCLUDES = ['index.md', 'README.md'];
...
function load(app) {
  ...
  app.renderer.on(RendererEvent.END, () => {
    // Remove TypeDoc-generated index/README files (we maintain index.mdx manually)
    for (const excludeFile of GENERATED_EXCLUDES) {
      const excludePath = path.join(sdkOutputDir, excludeFile);
