...
5. **Database snapshots:**
   ...
   - [Path node explorer](https://snapshot-explorer.arbitrum.io/?chain=arb1)
...
:::note Path node additional flags

For a Nitro path archive node:
...
For a Nitro partial path archive node:
...
## Path node configuration details
