...
This page assumes you have completed the steps from the [Start here](/run-arbitrum-node/start-here.mdx) page; if you have not you will need to do so as it gathers RPC endpoints, Nitro version, database snapshots, etc.) that is required to run the node.
