...
Now that you have all the prerequisite information ready—it's time to run your node. Following the instructions on the [Run a full node](/run-arbitrum-node/02-run-full-node.mdx) page.
