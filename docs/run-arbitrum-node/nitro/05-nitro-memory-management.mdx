...
**Stylus WASM cache** stores compiled WebAssembly modules for Stylus smart contracts. It is allocated via Rust (invoked through CGO) and bounded by `stylus-lru-cache-capacity`.
