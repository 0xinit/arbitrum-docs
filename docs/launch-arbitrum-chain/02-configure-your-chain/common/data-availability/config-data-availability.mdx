...
During Arbitrum chain configuration, you will choose the data availability (DA) option that best suits your needs. This choice affects how transaction data is stored and accessed for validation—impacting security, costs, and performance.
...
- Configure nodes (sequencer, batch poster, validators) to connect to the DAS endpoints (via REST/RPC aggregators).
