...
| `arbitrum.MaxCodeSize`               | number  | Sets the maximum size for contract bytecodes on the chain (it's recommended to use the default 24Kb, and not set it higher than 96Kb). For more information refer to the [Smart contract size limit page](/launch-arbitrum-chain/02-configure-your-chain/common/validation-and-security/config-smart-contract-size-limit.mdx) |
...
import SizeLimit from '../partials/_size-limit.mdx';
