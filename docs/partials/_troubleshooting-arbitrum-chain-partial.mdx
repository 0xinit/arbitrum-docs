...
Learn more: [Chain SDK introduction](https://docs.arbitrum.io/launch-arbitrum-chain/arbitrum-chain-sdk-introduction).
...
Learn more: [AEP license](https://docs.arbitrum.io/launch-arbitrum-chain/aep-license).
...
Learn more: [Third-party providers](https://docs.arbitrum.io/launch-arbitrum-chain/06-third-party-integrations/02-third-party-providers).
...
Learn more: [Customize the State Transition Function](https://docs.arbitrum.io/launch-arbitrum-chain/05-customize-your-chain/customize-stf).
...
Learn more: [Configure data availability](https://docs.arbitrum.io/launch-arbitrum-chain/02-configure-your-chain/common/data-availability/config-data-availability).
...
Learn more: [Choose a custom gas token](https://docs.arbitrum.io/launch-arbitrum-chain/features/common/gas-and-fees/choose-custom-gas-token).
...
Learn more: [ZeroDev smart account integration](https://docs.arbitrum.io/for-devs/third-party-docs/ZeroDev/zero-dev).
...
Learn more: [Monitoring tools and block explorers](https://docs.arbitrum.io/build-decentralized-apps/reference/06-monitoring-tools-block-explorers).
...
Learn more: [The Graph](https://docs.arbitrum.io/for-devs/third-party-docs/TheGraph/thegraph).
...
For more information refer to the [Smart contract size limit page](https://docs.arbitrum.io/launch-arbitrum-chain/02-configure-your-chain/common/validation-and-security/config-smart-contract-size-limit)
...
Learn more: [Fee management](https://docs.arbitrum.io/launch-arbitrum-chain/02-configure-your-chain/common/fees/07-fee-management).
...
Learn more: [Gas and fees deep dive](https://docs.arbitrum.io/how-arbitrum-works/deep-dives/gas-and-fees).
...
Learn more: [Sequencer timing adjustments](https://docs.arbitrum.io/launch-arbitrum-chain/features/advanced/sequencer-timing-adjustments).

### Can I set fast deposits for an L3?

Yes, we have documented fast deposits in [how to configure delayed inbox finality](https://docs.arbitrum.io/launch-arbitrum-chain/02-configure-your-chain/common/validation-and-security/arbitrum-chain-finality).
...
Learn more: [Run a validator node](https://docs.arbitrum.io/run-arbitrum-node/more-types/02-run-validator-node).
...
Learn more: [BoLD economics of disputes](https://docs.arbitrum.io/how-arbitrum-works/bold/bold-economics-of-disputes).
...
Learn more: [Nitro database snapshots](https://docs.arbitrum.io/run-arbitrum-node/nitro/03-nitro-database-snapshots).
...
It's possible to run it in the same container. That is the default way, and then Nitro uses a loopback connection. You can read more about this in [running a split-validator](https://docs.arbitrum.io/launch-arbitrum-chain/07-arbitrum-node-runners/04-run-split-validator-node).
