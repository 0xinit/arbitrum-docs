...
- If you need a full list of Arbitrum networks, you can use the new [`getArbitrumNetworks`](https://github.com/OffchainLabs/arbitrum-sdk/blob/main/packages/sdk/src/lib/dataEntities/networks.ts#getarbitrumnetworks) function.
- To list all of the children of a network, use the new [`getChildrenForNetwork`](https://github.com/OffchainLabs/arbitrum-sdk/blob/main/packages/sdk/src/lib/dataEntities/networks.ts#getchildrenfornetwork) function.

| v3 Name               | v4 Name                                                                                            |
| --------------------- | -------------------------------------------------------------------------------------------------- |
| `L2Network`           | [`ArbitrumNetwork`](https://github.com/OffchainLabs/arbitrum-sdk/blob/main/packages/sdk/src/lib/dataEntities/networks.ts#arbitrumnetwork)                             |
...
| `l2Networks`          | [`getArbitrumNetworks`](https://github.com/OffchainLabs/arbitrum-sdk/blob/main/packages/sdk/src/lib/dataEntities/networks.ts#getarbitrumnetworks)                     |
| `addCustomNetwork`    | [`registerCustomArbitrumNetwork`](https://github.com/OffchainLabs/arbitrum-sdk/blob/main/packages/sdk/src/lib/dataEntities/networks.ts#registercustomarbitrumnetwork) |
| `Network`             | *removed*                                                                                          |
| `L1Network`           | *removed*                                                                                          |
...
`Network` type has been replaced with the [`ArbitrumNetwork`](https://github.com/OffchainLabs/arbitrum-sdk/blob/main/packages/sdk/src/lib/dataEntities/networks.ts#arbitrumnetwork) type and some properties have been removed or renamed.
...
The `TokenBridge` type within the[`ArbitrumNetwork`](https://github.com/OffchainLabs/arbitrum-sdk/blob/main/packages/sdk/src/lib/dataEntities/networks.ts#arbitrumnetwork) object has been updated.
