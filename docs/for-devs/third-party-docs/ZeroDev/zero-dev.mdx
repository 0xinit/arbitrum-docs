...
Gas fees are one of the biggest barriers to blockchain adoption. ZeroDev, built by Offchain Labs (the creators of Arbitrum), solves this problem by enabling gasless transactions on Arbitrum through sponsored User Operations (UserOps). These are powered by our ERC-4337 compliant Kernel Smart Account.
With ZeroDev, you can:

- Eliminate gas fees for your users by sponsoring their transactions.
- Utilize Plugins for advanced features like Passkey support, fine-grained permissions, and Session Keys.
...
2. If you have an existing project, you can simply enable Arbitrum One or Arbitrum Sepolia for it—you do not need to create a new project for every chain.
...
const entryPoint = getEntryPoint('0.7'); // [cite: 8610, 9028]
...
const ecdsaValidator = await signerToEcdsaValidator(publicClient, {
  signer,
  entryPoint,
  kernelVersion: KERNEL_V3_3, // [cite: 9055]
});
...
You have successfully integrated ZeroDev and implemented gasless, batched transactions on Arbitrum. This configuration, leveraging our V3 RPC and Kernel V3.3, ensures a high-performance, gas-free experience for your users.
...
Need further help? We got you! Check out all the ways you can reach ZeroDev for further questions and support:
