...
1. Soft finality emerges immediately upon the inclusion into the Sequencer feed, offering instant acceptance feedback, a commitment to order, and the ability to act without wait times—as noted in the submission phase. This “soft finality” relies on the Sequencer’s trustworthiness for usability but lacks cryptographic backing.
