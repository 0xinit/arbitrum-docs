...
Arbitrum provides public RPC endpoints for <a data-quicklook-from="arbitrum-one">Arbitrum One, Nova</a>, and Sepolia. These endpoints are rate-limited, making them best for:
