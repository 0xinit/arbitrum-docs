...
This approach sets an effective gas target for the execution of a Nitro chain: in the long run, the chain can't progress faster than a validator can emulate its execution. If assertions are published faster than the gas target, their deadlines will keep moving farther into the future. Due to the Rollup protocol's limit on how far a deadline can be in the future, this will eventually slow new assertions, thereby enforcing the effective gas target.
