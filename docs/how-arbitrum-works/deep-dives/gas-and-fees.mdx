...
1. **Batch posting report generation**: The parent chain inbox inserts a "batch posting report" transaction into the chain's <a data-quicklook-from="delayed-inbox">Delayed Inbox</a>. After a delay, this report gets processed by ArbOS's pricer module.
