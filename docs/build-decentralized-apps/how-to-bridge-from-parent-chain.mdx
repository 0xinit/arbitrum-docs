...
Understanding these parameters helps ensure successful retryable ticket creation:
...
- For token bridging, see [Token bridging overview](/how-arbitrum-works/deep-dives/token-bridging.mdx)
- For bridging tokens programmatically, see [Bridge tokens programmatically](/build-decentralized-apps/token-bridging/get-started.mdx)
