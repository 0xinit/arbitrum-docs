...
This guide explains how to programmatically send messages and withdraw assets from an Arbitrum child chain to a parent chain (such as Ethereum). For conceptual information about the messaging protocol, see [Child-to-parent chain messaging](/how-arbitrum-works/deep-dives/l2-to-l1-messaging.mdx).
...
2. **Wait for finalization**: The message enters a 6.4-day challenge period
...
2. **Challenge period**: Wait 6.4 days for the assertion to finalize
